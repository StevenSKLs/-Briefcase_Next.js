...
`
            ...
            <div className="absolute w-[120vh] text-center top-[2vh] z-[2] ">
                <h1 className="textShadow text-[2.2rem]">
                    <span>
                        {text}
                    </span>
                    <Cursor cursorColor="red" />
                </h1>
                <h2 className="textShadow text-[1.3rem] mt-[12.5rem] mb-[4rem]">
                ...
                <h2 className="textShadow text-red text-[1rem]">
